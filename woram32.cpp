...
void Woram32MainAddWidgets(HWND hWnd) {
    ...
    HFONT hFontNum = CreateFont(-W32_TEXT_SMALL, 0, 0, 0, FW_DONTCARE, FALSE, TRUE, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH, NULL);
    HFONT hFontOut = CreateFont(-W32_TEXT_LARGE, 0, 0, 0, FW_BOLD, FALSE, FALSE, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH, NULL);

    hNum = CreateWindow("static", "99", WS_VISIBLE | WS_CHILD | ES_RIGHT, 0, 0, W32_SZY, W32_SZY, hWnd, NULL, NULL, NULL);
    hOut = CreateWindow("static", "-99.99 -99.99 -99.99 -99.99", WS_VISIBLE | WS_CHILD | ES_CENTER, W32_SZY, 0, W32_SZX - W32_SZY, W32_SZY, hWnd, NULL, NULL, NULL);
